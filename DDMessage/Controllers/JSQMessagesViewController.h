...
typedef NS_ENUM(NSUInteger, POIInputViewType) {
    POIInputViewTypeText  = 0,
    POIInputViewTypeMedia = 1
};
/**
 ...
 */
@property (assign,nonatomic) POIInputViewType inputViewType;
/**
...
/**
 *  This method is called when the user taps the voice button on the `inputToolbar`.
 *
 *  @param sender The voice button that was pressed by the user.
 */
