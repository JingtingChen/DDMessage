...
- (void)jsq_configureMessagesViewController
{
    ...
    self.inputToolbar.contentView.textView.placeHolder = NSLocalizedStringFromTable(@"输入文字", @"JSQMessages", @"Placeholder text for the message input text view");
...
- (void)didPressVoiceButton:(UIButton *)sender
{
    NSAssert(NO, @"Error! required method not implemented in subclass. Need to implement %s", __PRETTY_FUNCTION__);
}

- (void)didReleaseVoiceButton:(UIButton *)sender
{
    NSAssert(NO, @"Error! required method not implemented in subclass. Need to implement %s", __PRETTY_FUNCTION__);
}
...
-(id<JSQMessageBubbleImageDataSource>)collectionView:(JSQMessagesCollectionView *)collectionView systemMessageBubbleImageDataForItemAtIndexPath:(NSIndexPath *)indexPath
{
  NSAssert(NO, @"ERROR: required method not implemented: %s", __PRETTY_FUNCTION__);
  return nil;
}
...
- (UICollectionViewCell *)collectionView:(JSQMessagesCollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (!isMediaMessage) {
      ...
      id<JSQMessageBubbleImageDataSource> bubbleImageDataSource;
      
      if (isSystemMessage){
        bubbleImageDataSource = [collectionView.dataSource collectionView:collectionView systemMessageBubbleImageDataForItemAtIndexPath:indexPath];
      }else{
        bubbleImageDataSource = [collectionView.dataSource collectionView:collectionView messageBubbleImageDataForItemAtIndexPath:indexPath];
      }
...
-(CGFloat)collectionView:(JSQMessagesCollectionView *)collectionView layout:(JSQMessagesCollectionViewFlowLayout *)collectionViewLayout HorizontalForMessageContainerViewAtIndexPath:(NSIndexPath *)indexPath
{
  return [collectionViewLayout sizeForHorizontalWidthForMessageContainerAtIndexPath:indexPath];
}
...
- (void)messagesInputToolbar:(JSQMessagesInputToolbar *)toolbar didPressVoiceBarButton:(UIButton *)sender
{
    [self didPressVoiceButton:sender];
}

- (void)messagesInputToolbar:(JSQMessagesInputToolbar *)toolbar didReleaseVoiceBarButton:(UIButton *)sender
{
    [self didReleaseVoiceButton:sender];
}
...
-(BOOL)textViewShouldBeginEditing:(UITextView *)textView{
    self.inputViewType=POIInputViewTypeText;
    return YES;
}
...
- (void)keyboardController:(JSQMessagesKeyboardController *)keyboardController keyboardDidChangeFrame:(CGRect)keyboardFrame
{
    ...
    if (self.inputViewType==POIInputViewTypeMedia) {
...
#pragma mark - method add by Jimmy
-(void)showMultiMediaView{
