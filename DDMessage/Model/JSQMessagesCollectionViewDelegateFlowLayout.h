 ...
 */
- (CGFloat)collectionView:(JSQMessagesCollectionView *)collectionView
                   layout:(JSQMessagesCollectionViewFlowLayout *)collectionViewLayout HorizontalForMessageContainerViewAtIndexPath:(NSIndexPath *)indexPath;
...
/**
 *  Notifies the delegate that the resend Image at the specified indexPath did receive a tap event.
 *
 *  @param collectionView The collection view object that is notifying the delegate of the tap event.
 *  @param indexPath      The index path of the item for which the message bubble was tapped.
 */
- (void)collectionView:(JSQMessagesCollectionView *)collectionView didTapResendAtIndexPath:(NSIndexPath *)indexPath;
...
/**
 *  POIChatFooterView delegate
 */
- (void)showAdoptAlert;
- (void)pushToUploadAnswerViewController;
- (void)showUploadInformationFromButton:(UIButton *)button;
@end
