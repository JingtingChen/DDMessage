...
- (void)setMessageContainerHorizontalWidth:(CGFloat)messageContainerHorizontalWidth
{
  NSParameterAssert(messageContainerHorizontalWidth >= 0.0f);


  _messageContainerHorizontalWidth = [self jsq_correctedMessageContainerHorizontalWidthForWidth:messageContainerHorizontalWidth];
}
...
- (CGFloat)jsq_correctedMessageContainerHorizontalWidthForWidth:(CGFloat)width
{
  return ceilf(width);
}
...
- (BOOL)isEqual:(id)object
{
    ...
    if (self.representedElementCategory == UICollectionElementCategoryCell) {
        ...
        if (![layoutAttributes.messageBubbleFont isEqual:self.messageBubbleFont]
            ...
            || (int)layoutAttributes.messageContainerHorizontalWidth != (int)self.messageContainerHorizontalWidth){
            return NO;
        }
    }
...
- (instancetype)copyWithZone:(NSZone *)zone
{
    ...
    copy.messageContainerHorizontalWidth = self.messageContainerHorizontalWidth;
    return copy;
}
