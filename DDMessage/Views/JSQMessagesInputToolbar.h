...
/**
 * Tells the delegate that the toolbar's `voiceBarButtonItem` has been pressed
 *
 * @param toolbar The object representing the toolbar sending this information.
 * @param sender  The button that received the touch event.
 */
- (void)messagesInputToolbar:(JSQMessagesInputToolbar *)toolbar
      didPressVoiceBarButton:(UIButton *)sender;

/**
 * Tells the delegate that the toolbar's `voiceBarButtonItem` has been release
 *
 * @param toolbar The object representing the toolbar sending this information.
 * @param sender  The button that received the touch event.
 */
- (void)messagesInputToolbar:(JSQMessagesInputToolbar *)toolbar
      didReleaseVoiceBarButton:(UIButton *)sender;
@end
