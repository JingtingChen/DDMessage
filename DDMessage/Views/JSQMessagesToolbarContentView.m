...
@property (weak, nonatomic) IBOutlet UIView                      *voiceBarButtonContainerView;
...
- (void)awakeFromNib
{
    ...
    [self setupVoiceButtonContainerViewStyle];
}
...
- (void)dealloc
{
    ...
    _voiceBarButtonContainerView = nil;
}
...
- (void)setupVoiceButtonContainerViewStyle {

    CGFloat cornerRadius = 6.0f;

    self.voiceBarButtonContainerView.backgroundColor = [UIColor whiteColor];
    self.voiceBarButtonContainerView.layer.borderWidth = 0.5f;
    self.voiceBarButtonContainerView.layer.borderColor = [UIColor lightGrayColor].CGColor;
    self.voiceBarButtonContainerView.layer.cornerRadius = cornerRadius;
}
...
- (void)setVoiceBarButtonItem:(UIButton *)voiceBarButtonItem{

    if(_voiceBarButtonItem){
        [_voiceBarButtonItem removeFromSuperview];
    }
    
    if (!voiceBarButtonItem) {
        _voiceBarButtonItem = nil;
        self.voiceBarButtonContainerView.hidden = YES;
        return ;
    }
    
    
    self.voiceBarButtonContainerView.hidden = YES;
    [self.voiceBarButtonContainerView addSubview:voiceBarButtonItem];

    _voiceBarButtonItem = voiceBarButtonItem;
}
