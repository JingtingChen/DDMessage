...
@property (weak, nonatomic) IBOutlet NSLayoutConstraint *messageBubbleContainerHorizontalConstraint;
...
- (void)applyLayoutAttributes:(UICollectionViewLayoutAttributes *)layoutAttributes
{
    ...
    [self jsq_updateConstraint:self.messageBubbleContainerHorizontalConstraint withConstant:customAttributes.messageContainerHorizontalWidth];
...
- (void)jsq_handleTapGesture:(UITapGestureRecognizer *)tap
{
    ...
    else if (CGRectContainsPoint(self.messageIndicator.frame, touchPt)){
        [self.delegate messagesCollectionViewCellDidTapMessageResend:self];
    }
    else {
