...
#import "../../../../wolaiSocial/MessageIndicator.h"
...
/**
 *  Tells the delegate that the resend button of the cell has been tapped.
 *
 *  @param cell The cell that received the tap touch event.
 */
- (void)messagesCollectionViewCellDidTapMessageResend:(JSQMessagesCollectionViewCell *)cell;
...
@property (weak, nonatomic) IBOutlet MessageIndicator        *messageIndicator;
